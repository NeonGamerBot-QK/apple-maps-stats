...
const example_phrases = [
  {
    phrase:
      "I will arrive at [location] around [timestamp]. I'll let you know if i'm running late.",
...
test("hashEmail", () => {
  expect(hashEmail("neon@saahild.com")).toBe(
    "7800332736cac2e8096ed46d0ee27bd2",
  );
});
